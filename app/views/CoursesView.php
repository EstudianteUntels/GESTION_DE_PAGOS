...
class CoursesView
{
  public function formCourses($courses)
  {
?>
    <style>
      input[type=checkbox] {
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        ...
                        <td>
                          <?php echo $course->course . " - " . $course->level ?>
                        </td>
                        <td class="">
                          <p><?php echo $course->description ?></p>
                        </td>
                        <td class="text-right">
                          <?php echo number_format($course->total_amount, 2) ?>
                        </td>
                        <td class="text-center">
                          <button class="btn btn-primary edit_course" type="button" data-id="<?php echo $course->id ?>"><i class="fa fa-edit"></i></button>
                          <button class="btn btn-danger delete_course" type="button" data-id="<?php echo $course->id ?>"><i class="fa fa-trash-alt"></i></button>
                        </td>
                      </tr>
                    <?php endforeach; ?>
                  </tbody>
