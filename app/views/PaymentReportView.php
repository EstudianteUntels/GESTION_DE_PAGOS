          ...
          <div class="card">
            <div class="card_body">
              <div class="right pt-1">
                <h3>Bienenid@ <?php echo $name ?></h3>
              </div>
              <div class="row justify-content-center pt-4">

                <br><label for="" class="mt-2">Registro de Pagos</label><br />
              </div>
              <hr>
              <div class="col-md-12">
                <table class="table table-bordered" id='report-list'>
                  ...
                  <tbody>
                    ...
                    $i = 1;
                    $total = 0;
                    $payments = $conn->query("SELECT p.*,s.name as sname, ef.ef_no,s.id_no,p.date_created FROM payments p inner join student_ef_list ef on ef.id = p.ef_id inner join student s on s.id = ef.student_id where s.email = '$username' order by unix_timestamp(p.date_created) asc ");
              ...
              <div class="col-md-12">
                <table class="table table-bordered" id='report-list'>
                  ...
                  <tbody>
                    ...
                    $i = 1;
                    $total = 0;
                    $payments = $conn->query("SELECT p.*,s.name as sname, ef.ef_no,s.id_no,p.date_created FROM payments p inner join student_ef_list ef on ef.id = p.ef_id inner join student s on s.id = ef.student_id where date_format(p.date_created,'%Y-%m') = '$month' order by unix_timestamp(p.date_created) asc ");
                    if ($payments->num_rows > 0) :
                      while ($row = $payments->fetch_array()) :
                        $total += $row['amount'];
                    ?>
